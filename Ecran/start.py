...
class Start(pygame.sprite.Sprite):
    ...
    def add_parties(self,nom):
        ...
        niveau1 = Niveau(player1, steps, powersUp, ennemies, self.screen, "Unlocked")
        niveau2 = Niveau(player1, steps, powersUp, ennemies, self.screen)
        niveau3 = Niveau(player1, steps, powersUp, ennemies, self.screen)
        niveau4 = Niveau(player1, steps, powersUp, ennemies, self.screen)
        niveau5 = Niveau(player1, steps, powersUp, ennemies, self.screen)
        niveau6 = Niveau(player1, steps, powersUp, ennemies, self.screen)
